...
- Phase 3: LLM transmutation (local Ollama client)
...
from app.services.nlp.text_llm_client_ollama_demo import generate_text
...
def transmute_text(text: str, cognitive_state: str) -> dict:
    ...
    try:
        ...
        print(f"[AdaptiveTextEngineDemo] LLM call failed, falling back to original text: {e}")
        llm_error = str(e)
        llm_output = text
